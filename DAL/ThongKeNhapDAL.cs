...
namespace DAL
{
    public class ThongKeNhapDAL
    {
        ...
        public List<PhieuNhapDTO> GetThongKePhieuNhapHangHoaData()
        {
            ...
            string query = @"Select ct.MaHang, Sum(ct.SoLuongXuat) AS TongSoLuongXuat from PhieuNhap pn left join ChiTietPhieuXuat ct
        ...
        {
            List<PhieuNhapDTO> data = new List<PhieuNhapDTO>();
            string query = @"Select ct.MaHang, Sum(ct.SoLuongNhap) AS TongSoLuongNhap from PhieuNhap pn left join ChiTietPhieuNhap ct
                             On pn.MaPhieuNhap = ct.MaPhieuNhap
